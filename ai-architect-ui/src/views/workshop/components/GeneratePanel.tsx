...
export function GeneratePanel({
  ...
  return (
    <div
      ...
      className={`mx-3 mb-2 rounded-xl border px-4 py-3 ${borderClass}`}
    >
      ...
      <div className="mt-3 flex flex-wrap gap-2">
        {stateC ? null : (
          <button
            ...
            className="rounded-xl border border-gray-300 bg-white px-3 py-2 text-[12px] font-medium text-gray-800 hover:bg-gray-50 disabled:opacity-50"
          >
