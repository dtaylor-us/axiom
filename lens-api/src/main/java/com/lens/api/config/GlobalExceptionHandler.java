...
public class GlobalExceptionHandler {
    ...
    public ProblemDetail handleNotFound(ResourceNotFoundException ex) {
        ...
        problem.setType(URI.create("urn:lens:not-found"));
        return problem;
    }
    ...
    public ProblemDetail handleConflict(ConflictException ex) {
        ...
        problem.setType(URI.create("urn:lens:conflict"));
        return problem;
    }
    ...
    public ProblemDetail handleBadRequest(RuntimeException ex) {
        ...
        problem.setType(URI.create("urn:lens:bad-request"));
        return problem;
    }
    ...
    public ProblemDetail handleValidation(MethodArgumentNotValidException ex) {
        ...
        problem.setType(URI.create("urn:lens:validation-error"));
        return problem;
    }
    ...
    public ProblemDetail handleUnhandled(Exception ex) {
        ...
        problem.setType(URI.create("urn:lens:internal-error"));
        return problem;
    }
}
